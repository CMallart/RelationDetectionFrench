...
#Twisted an option to have Enhanced++ dependency parsing
...
if __name__ == "__main__":
    corenlpparser = CoreNLPDependencyParser(url='http://localhost:'+ str(9004))
    print(list(corenlpparser.raw_parse("Nous irons aux alpages à partir de juin."))[0]) 